...
assert manifest.get("world_size") == 3, manifest
assert manifest.get("effective_batch_size") == 48, manifest
print(json.dumps({
...
print(json.dumps({
    ...
    "three_rank_actor_warmstart_loaded": True,
}, indent=2))
PY
